 ...
 * vaadin-spring-binder.conversion.order} and the same {@code ValidatorFactory} as injected binders,
...
public interface SpringBinderFactory {
     ...
     */
    <BEAN> SpringBinder<BEAN> create(Class<BEAN> beanType);
     ...
     * @return a new binder, never {@literal null}.
     */
    <BEAN> SpringBinder<BEAN> create(Class<BEAN> beanType, boolean scanNestedDefinitions);
     ...
     */
    <BEAN> SpringBeanValidationBinder<BEAN> createBeanValidation(Class<BEAN> beanType);
     ...
     * @throws IllegalStateException if no JSR-303 provider is available.
     */
    <BEAN> SpringBeanValidationBinder<BEAN> createBeanValidation(Class<BEAN> beanType, boolean scanNestedDefinitions);
}
