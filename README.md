...
An injectable Vaadin Binder implementation integrated with Spring services.

SpringBinder Add-On provides the following features:

- Automatically applies conversions provided by Spring `ConversionService` or
  falls back to default converts.
- BeanValidationBinder implementation that integrates with
  Spring `ValidatorFactory` for message interpolation.

To use the add-on in your project import the `SpringBinderConfiguration` class.
...
here [Resource Cheat Sheet](https://vaadin.com/docs/v14/flow/importing-dependencies/tutorial-ways-of-importing.html#resource-cheat-sheet)
in more details.
